...
function SideNav({params}) {
    ...
    const CreateNewDocument=async()=>{
        ...
        console.log('SideNav navigation workspaceid:', params?.workspaceid, 'docId:', docId);
    ...
    <div className='h-screen md:w-72 hidden md:block fixed bg-blue-50 p-5 shadow-md'>
        ...
        <div>
            <div className='flex justify-between items-center'>
                ...
                <Button size={'sm'} className="text-lg" onClick={CreateNewDocument}>{loading?<Loader2Icon className='h-4 w-4 animate-spin'/> :'+'}</Button>
            </div>
        </div>
