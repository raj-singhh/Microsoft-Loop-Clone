import { Link2Icon, MoreVertical, PenBox, PenIcon, Trash2 } from 'lucide-react'
    ...
    <div>
        <DropdownMenu>
            ...
            <DropdownMenuContent>
                ...
                <DropdownMenuItem className="flex gap-2 text-red-500" onClick={()=>deleteDocument(doc?.id)}><Trash2 className='h-4 w-4'/>Delete</DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
    </div>
  )
